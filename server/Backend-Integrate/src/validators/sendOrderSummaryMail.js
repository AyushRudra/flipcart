    ...
    let success = await transporter.sendMail({
      ...
      html: `
        <div style="text-align:center;">
          ...
          <br>
          <h3>Track your order: ${process.env.HOST_URL}/order/${order._id}</h3>
        </div>
        <hr style="width: 100%;">
        ...
        <table style="width:100%; height:100%; font-size:14px;  border-spacing: 10px;">
          <tbody>
            <tr>
              ...
              <td style="text-align:end;">$ ${order.totalPrice}</td>
            </tr>
          </tbody>
        </table>
        <br>
        <h3>Please do not hesitate to contact us if you have any questions.</h3>
